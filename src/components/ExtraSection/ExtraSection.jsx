        ...
        <div>
            <div  className="hero min-h-screen ">
                <div className="hero-content w-full flex-col lg:flex-row">
                    <img data-aos="fade-right"  src="https://images.pexels.com/photos/4934420/pexels-photo-4934420.jpeg?auto=compress&cs=tinysrgb&w=600" className=" rounded-lg shadow-2xl" />
            ...
            <div className='grid grid-cols-1 md:grid-cols-3'>
                <div data-aos="fade-up-right">
                    ...
                    <p className='text-[#4F4F4F] mb-20 '>A toy truck is a miniature vehicle designeed for play and imagination. It often resembles a real truck, complete with wheels, a chassis, and a bed for carrying objects. Children enjoy pushing, pulling, and racing toy trucks, creating adventures in their own imaginary worlds.</p>
                </div>
